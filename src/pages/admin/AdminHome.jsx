              ...
              <div className="col-md-6">
                <div className="card card-dark h-100 p-3">
                  <div className="d-flex align-items-start gap-3">
                    <div
                      className="rounded-circle bg-info-subtle"
                      style={{ width: 48, height: 48 }}
                    />
                    <div>
                      <h5 className="text-light mb-1">Anggota</h5>
                      <p className="text-white-80 mb-3">
                        Kelola data anggota (tambah, ubah, hapus).
                      </p>
                ...
                <div className="card card-dark h-100 p-3">
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white-80 mb-3">
                        Kelola berita & agenda (tambah, ubah, hapus).
                      </p>
                      <div className="d-flex gap-2">
                        <Link
                          to="/admin/berita"
                ...
                <div className="card card-dark h-100 p-3">
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white-80 mb-3">
                        Kelola publikasi jurnal & konferensi.
                      </p>
                      <div className="d-flex gap-2">
                        <Link
                          to="/admin/jurnal"
              ...
              <div className="col-md-6">
                <div className="card card-dark h-100 p-3">
                  <div className="d-flex align-items-start gap-3">
                    ...
                    />
                    <div>
                      <h5 className="text-light mb-1">Collaborations</h5>
                      <p className="text-white-80 mb-3">
                        Kelola kolaborasi (tambah, ubah, hapus).
                      </p>
                      <div className="d-flex gap-2">
                        <Link
                          to="/admin/kolaborasi"
